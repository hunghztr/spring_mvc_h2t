...
<main class="flex-1 ml-[300px] mr-[100px] mt-[30px]">
    <h1 class="text-2xl font-bold mb-4 text-center">Danh sách màu</h1>


    <div class="mb-4 text-right">
        <a href="/admin/color/create"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <tbody>
            <c:forEach var="p" items="${colors}">
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-2 px-4">${p.id}</td>
                    <td class="py-2 px-4">${p.name}</td>
                    <td class="py-2 px-4">
                        <form action="/admin/color/delete/${p.id}" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn xóa khuyến mãi này?');">
