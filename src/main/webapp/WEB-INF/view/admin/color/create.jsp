...
<main class="ml-[300px] mr-[100px] mt-[30px] p-6 bg-white rounded shadow-md">
    ...
    <form:form modelAttribute="color" method="post" action="/admin/color/create" class="space-y-6">
        <div>
            <label class="block font-medium mb-1">Màu</label>
            <form:input path="name" type="text" cssClass="w-full border border-gray-300 rounded px-4 py-2" />
        </div>
